...
export default function() {
	return {
		editFormFields: {"gongChang":"","cheJian":"","riQi":"","gongXu":"","jiTai":"","xingHao":"","yiChangFenLei":"","buLiangShuLiang":"","queXianDaiMa":"","shiFouDuiCe":"","shiFouYouXiao":"","shiFouGuanBi":"","shiFouCongFu":"","hengJiuGaiShan":"","wenTiDian":"","yuanYinFenXi":"","gaiShanCuoShi":"","zeRenBuMen":"","zeRenRen":"","naQi":"","shiJiWanChengShiJian":"","chaoQiTianShu":"","anShiWanCheng":"","zhuangTai":"","beiZhu":""},
		...
		searchFormFields: {"gongChang":"","cheJian":"","riQi":"","gongXu":[],"jiTai":[],"xingHao":[],"yiChangFenLei":[],"queXianDaiMa":[],"zeRenBuMen":"","zeRenRen":""},
		searchFormOptions: [{"key":"异常管理责任部门","data":[],"title":"责任部门","field":"zeRenBuMen","type":"select"},{"title":"责任人","field":"zeRenRen"},{"type":"group"},{"key":"工厂","data":[],"title":"工厂","field":"gongChang","type":"select"},{"key":"车间","data":[],"title":"车间","field":"cheJian","type":"select"},{"title":"日期","field":"riQi","type":"date"},{"type":"group"},{"key":"工序","data":[],"title":"工序","field":"gongXu","type":"selectList"},{"key":"机台","data":[],"title":"机台","field":"jiTai","type":"selectList"},{"key":"型号","data":[],"title":"型号","field":"xingHao","type":"selectList"},{"type":"group"},{"key":"异常分类","data":[],"title":"异常分类","field":"yiChangFenLei","type":"selectList"},{"key":"缺陷代码","data":[],"title":"缺陷代码","field":"queXianDaiMa","type":"selectList"}],
		columns: [{field:'gongChang',title:'工厂',type:'string',bind:{ key:'工厂',data:[]}},
                       {field:'cheJian',title:'车间',type:'string',bind:{ key:'车间',data:[]}},
