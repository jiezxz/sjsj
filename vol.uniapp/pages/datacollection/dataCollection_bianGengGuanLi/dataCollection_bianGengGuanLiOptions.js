...
export default function() {
	return {
		...
		searchFormFields: {"DocumentNumber":"","gongChang":"","gongXu":"","shengChanXian":[],"lianLuoShiYou":""},
		searchFormOptions: [{"title":"文件编号","field":"DocumentNumber","type":"like"},{"key":"工厂","data":[],"title":"工厂","field":"gongChang","type":"select"},{"key":"工序","data":[],"title":"工序","field":"gongXu","type":"select"},{"key":"产线SQL","data":[],"title":"生产线","field":"shengChanXian","type":"selectList"},{"type":"group"},{"key":"联络事由","data":[],"title":"联络事由","field":"lianLuoShiYou","type":"select"}],
