...
export default function() {
	return {
		editFormFields: {"gongChang":"","xjsj":"","diDian":"","chanXian":"","wtms":"","yctp":"","sfcf":"","cqcs":"","gsbm":"","zrr":"","zgqx":"","zgjg":"","wczt":""},
		...
		searchFormFields: {"gongChang":"","xjsj":"","diDian":"","chanXian":"","sfcf":"","wczt":""},
		searchFormOptions: [{"key":"工厂","data":[],"title":"工厂","field":"gongChang","type":"select"},{"title":"巡检日期","field":"xjsj","type":"date"},{"title":"具体位置 ","field":"diDian","type":"text"},{"key":"9S巡检区域SQL","data":[],"title":"车间/区域","field":"chanXian","type":"select"},{"type":"group"},{"key":"是否","data":[],"title":"重复发生2次指摘","field":"sfcf","type":"select"},{"type":"group"},{"key":"完成未完成","data":[],"title":"完成状态","field":"wczt","type":"select"}],
