...
<template>
    <div>
        ...
        <gridHeader ref="gridHeader"></gridHeader>
    </div>
</template>
<script>
...
export default defineComponent({
    setup() {
        ...
        const editFormFields = ref({ "DocumentNumber": "", "chejian": "", "renshu": "", "weidaors": "", "shidaors": "", "gonshang": "", "anquan": "", "qitayichang": "", "weiwancheng": "", "jiaojieren": "", "jiebanren": "", "zhishi": "", "rwshixiang": "", "chanxian": "", "banbie": "", "riqi": "", "guige": "", "jichuliang": "", "sv": "", "changdu": "", "mujuan": "", "chanliang": "", "zjjmianji": "", "zjjtubumj": "", "shichang": "", "mubiao": "", "Amubiao": "", "Achanliang": "", "dacheng": "", "shijiA": "", "yunzhuan": "", "zonchanliang": "", "yichang": "", "chanxianS": "", "banbieS": "", "riqiS": "", "guigeS": "", "jichuliangS": "", "svS": "", "changduS": "", "mujuanS": "", "chanliangS": "", "zjjtubumjS": "", "shichangS": "", "zjjmianjiS": "", "yunzhuanS": "", "zonchanliangS": "", "mubiaoS": "", "AmubiaoS": "", "AchanliangS": "", "dachengS": "", "shijiAS": "", "yichangS": "" });
        ...
        [{ "title": "工伤情况交接", "field": "gonshang", "type": "text" },
        { "title": "车间安全情况交接", "field": "anquan", "type": "text" },
        { "title": "9S未完成整改项交接", "field": "weiwancheng", "type": "text" },
        { "title": "其他异常情况", "field": "qitayichang", "type": "text" }],
        [{ "title": "交接人", "field": "jiaojieren", "type": "text" },
        { "title": "接班人", "field": "jiebanren", "type": "text" },
        { "title": "任务事项交接", "field": "rwshixiang", "type": "text" },
        { "title": "交接上级指示或部门文件通知看板更新等管理事宜", "field": "zhishi", "colSize": 6, "type": "text" }],
        [{ "dataKey": "产线-中文", "data": [], "title": "产线", "field": "chanxian", "type": "select" },
        { "dataKey": "班别", "data": [], "title": "班别(白/夜)", "field": "banbie", "type": "select" },
        ...
        [{ "title": "产线异常情况", "field": "yichang", "colSize": 12, "type": "textarea" }],
        [{ "dataKey": "产线-中文", "data": [], "title": "产线", "field": "chanxianS", "type": "select" },
        { "dataKey": "班别", "data": [], "title": "班别(白/夜)", "field": "banbieS", "type": "select" },
        ...
        [{ "title": "产线异常情况", "field": "yichangS", "colSize": 12, "type": "textarea" }]]);
        const searchFormFields = ref({ "DocumentNumber": "", "chejian": "", "chanxian": "", "jiaojieren": "", "banbie": "", "jiebanren": "" });
        const searchFormOptions = ref([[{ "dataKey": "车间", "data": [], "title": "车间", "field": "chejian", "type": "select" }, { "title": "文件编号", "field": "DocumentNumber", "type": "like" }, { "title": "交接人", "field": "jiaojieren", "type": "text" }], [{ "dataKey": "产线-中文", "data": [], "title": "产线", "field": "chanxian", "type": "select" }, { "dataKey": "班别", "data": [], "title": "班别(白/夜)", "field": "banbie", "type": "select" }, { "title": "接班人", "field": "jiebanren", "type": "text" }]]);
        const columns = ref([{ field: 'id', title: '序号', type: 'int', width: 110, hidden: true, readonly: true, require: true, align: 'left' },
        { field: 'DocumentNumber', title: '文件编号', type: 'string', width: 120, hidden: true, readonly: true, align: 'left' },
        { field: 'chejian', title: '车间', type: 'string', bind: { key: '车间', data: [] }, width: 120, align: 'left', sort: true },
        ...
        { field: 'banbie', title: '班别(白/夜)', type: 'string', bind: { key: '班别', data: [] }, width: 120, align: 'left' },
        { field: 'chanxianS', title: '产线', type: 'string', bind: { key: '产线-中文', data: [] }, width: 120, align: 'left' },
        { field: 'jiebanren', title: '接班人', type: 'string', width: 120, align: 'left' },
        { field: 'banbieS', title: '班别(白/夜)', type: 'string', bind: { key: '班别', data: [] }, width: 220, align: 'left' },
